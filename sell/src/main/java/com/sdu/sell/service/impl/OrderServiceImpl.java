...
import com.sdu.sell.converter.OrderMaster2OrderDTOConverter;
...
import com.sdu.sell.repository.OrderDetailRepository;
import com.sdu.sell.repository.OrderMasterRepository;
import com.sdu.sell.service.*;
...
//        orderMaster.setOrderId(orderId);
    ...
    public OrderDTO cancel(OrderDTO orderDTO) {
        ...
        if (CollectionUtils.isEmpty(orderDTO.getOrderDetailList())) {
            log.error("【取消订单】中订单无商品详情，orderDTO={}", orderDTO);
