...
import com.sdu.sell.utils.JsonUtil;
import com.sdu.sell.utils.MathUtil;
...
public class PayServiceImpl implements PayService {
    ...
    private static final String ORDER_NAME = "微信外卖订单。";
    ...
    //public void create(OrderDTO orderDTO) {
        ...
        //bestPayService.pay(payRequest);//测试获取四大参数是否成功：appId,appSecret,mchId,mchKey
        payRequest.setOpenid(orderDTO.getBuyerOpenid());
        //payRequest.setOrderAmount(23.00);
