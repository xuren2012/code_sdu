<nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation">
    <ul class="nav sidebar-nav">
        ...
        <li>
            <a href="/sell/seller/order/list1"><i class="fa fa-fw fa-list-alt"></i> 订单</a>
        </li>
        <li class="dropdown open">
            ...
            <ul class="dropdown-menu" role="menu">
                ...
                <li><a href="/sell/seller/product/list1">列表</a></li>
                <li><a href="/sell/seller/product/index1">新增</a></li>
            </ul>
        </li>
        <li class="dropdown open">
            ...
            <ul class="dropdown-menu" role="menu">
                <li class="dropdown-header">操作</li>
                <li><a href="/sell/seller/category/list1">列表</a></li>
                <li><a href="/sell/seller/category/index1">新增</a></li>
            </ul>
        </li>
